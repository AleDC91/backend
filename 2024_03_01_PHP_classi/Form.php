...
namespace ADC {
    ...
    class Form
    {
        ...
        function __construct(
            ...
            $this->allNames = [...$this->textFields, ...$this->emailFields, ...$this->passwordFields, ...$this->checkboxFields, ...$this->radioFields, ...$this->selectFields, ...$this->selectFields];
        }
        ...
        public function drawForm()
        {
            ...
            $textHTML $emailHTML $passwordHTML $radioHTML $selectHTML
